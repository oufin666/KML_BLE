...
//vitual addr version
#define GH3X2X_VIRTUAL_REG_VERSION_STRING "Gh3x2x_Virtual_Reg_v3.4"
//top
#define GH3X2X_TOP_INFO_ADDR 0x1000
#define GH3X2X_TOP_INFO_ADDR_END  (0x10E0 - 1)

#define GH3X2X_SLOT_LEDDRV_ADDR 0x10E0
#define GH3X2X_SLOT_LEDDRV_ADDR_END (0x1100 - 1)

#define GH3X2X_DUMP_CFG_ADDR 0x1100
#define GH3X2X_DUMP_CFG_ADDR_END (0x1120 - 1)

#define GH3X2X_FIFO_CTRL_ADDR 0x1120
#define GH3X2X_FIFO_CTRL_ADDR_END (0x1140 - 1)

#define GH3X2X_G_SENSOR_CFG_ADDR 0x1140
#define GH3X2X_G_SENSOR_CFG_ADDR_END (0x1160 -1)

#define GH3X2X_SOFT_AGC_PARA_ADDR 0x1160
#define GH3X2X_SOFT_AGC_PARA_ADDR_END       (0x1180 - 1)

#define GH3X2X_CAP_CFG_ADDR       0x1180
#define GH3X2X_CAP_CFG_ADDR_END      (0x11A0 - 1)

#define GH3X2X_TEMP_CFG_ADDR      0x11A0
#define GH3X2X_TEMP_CFG_ADDR_END  (0x2000 - 1)

#define GH3X2X_CHNL_MAP_ADDR 0x2000
#define GH3X2X_CHNL_MAP_ADDR_END (0x2880 - 1)

#define GH3X2X_FS_PARA_ADDR 0x2880
#define GH3X2X_FS_PARA_ADDR_END (0x3000 - 1)
...
#define GH3X2X_AGC_CONFIG_RES 0x1164
#define GH3X2X_AGC_GAIN_LIMIT_ADDR 0x1166
#define GH3X2X_AGC_TRIG_THD_H_LSB_16_ADDR 0x1168
#define GH3X2X_AGC_TRIG_THD_H_MSB_16_ADDR 0x116A
#define GH3X2X_AGC_TRIG_THD_L_LSB_16_ADDR 0x116C
#define GH3X2X_AGC_TRIG_THD_L_MSB_16_ADDR 0x116E
#define GH3X2X_AGC_RESTRAIN_THD_H_LSB_16_ADDR 0x1170
#define GH3X2X_AGC_RESTRAIN_THD_H_MSB_16_ADDR 0x1172
#define GH3X2X_AGC_RESTRAIN_THD_L_LSB_16_ADDR 0x1174
#define GH3X2X_AGC_RESTRAIN_THD_L_MSB_16_ADDR 0x1176
//cap_cfg
...
typedef struct
{
    GU16 usAddrStart;
    GU16 usAddrEnd;
    void (*ParmSet)(GU16 usVirtualRegAddr, GU16 usVirtualRegValue);
}STGhVirRegSwModuleInfo;
