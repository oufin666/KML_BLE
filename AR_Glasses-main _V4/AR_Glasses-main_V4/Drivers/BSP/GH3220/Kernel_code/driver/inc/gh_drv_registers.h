...
#define   GH3X2X_SLOT_ENABLE_CFG_REG_LSB                (0)
#define   GH3X2X_SLOT_ENABLE_CFG_REG_MSB                (7)
#define   GH3X2X_SLOT_RX_EN_FIFO_EN_LSB                 (2)
#define   GH3X2X_SLOT_RX_EN_FIFO_EN_MSB                 (6)
#define   GH3X2X_SLOT_FIFO_EN_LSB                       (6)
#define   GH3X2X_SLOT_FIFO_EN_MSB                       (6)
#define   GH3X2X_SLOT_CTRL_ADDR_INTERVAL                (0x1C)
#define   GH3X2X_SLOT_SR_MULTIPLIER_LSB                 (8)
#define   GH3X2X_SLOT_SR_MULTIPLIER_MSB                 (15)
...
#define GH3X2X_DCMT_EN_LSB  (0)
#define GH3X2X_DCMT_EN_MSB  (7)
#define GH3X2X_DCMT_DNSAMPLE_DIS_LSB  (8)
#define GH3X2X_DCMT_DNSAMPLE_DIS_MSB  (15)
#define GH3X2X_DCMT_HEAD_LSB  (0)
#define GH3X2X_DCMT_HEAD_MSB  (4)
#define GH3X2X_DCMT_RND_SEL_LSB  (8)
#define GH3X2X_DCMT_RND_SEL_MSB  (9)
...
#define   GH3X2X_RX_NUM_MAX                         (4)

#define   GH3X2X_DECIMAION_CHNL_MAX                 (8)         /** max channel number supported by decimaiton module in chip**/
...
#define   GH3X2X_SLOT_DC_CANCEL_BITS_SIZE            (8)         /**< slot tia gain val bits size */

#define   GH3X2X_SLOT_TIA_GAIN_BITS_MARK            (0x000F)    /**< slot tia gain val bits mark */
#define   GH3X2X_SLOT_DC_CANCEL_BITS_MARK           (0x00FF)    /**< slot tia gain val bits mark */
