 ...
 * 2021-08-12    zhengxiaoyu  v3.2.4.7    1.update algo lib
 * 2021-08-12    qiuchuitong  v3.2.4.8    1.update bt algo lib
 * 2021-12-16    zhengxiaoyu  v3.2.4.9    1.update hr/spo2/ecg/nadt algo lib
 * 2021-12-16    zhengxiaoyu  v3.2.5.0    1.interrupt mode change func
 *                                        2.result select and protocol update
 *                                        3.change some code format
 *                                        4.add Gh3x2xDemoStartSamplingWithCfgSwitch api
 *                                        5.fix some note error
 * 2021-12-16    zhengxiaoyu  v3.2.5.1    1.fix hrv algo hr result bug
 *                                        2.add check start sample func if exist in config
 * 2022-01-13    zhengxiaoyu  v3.2.5.2    1.rewrite nadt application process
 *                                        2.fix some bug
 * 2022-01-13    zhengxiaoyu  v3.2.5.3    1.update log define
 *                                        2.fix some bug
 ************************************************************************************
 * 2022-02-11    zhengxiaoyu  v4.0.0.0    1.delete all algo related section
 *                                        2.fix some format bug
 *                                        3.add some hook function
 * 2022-02-11    zhengxiaoyu  v4.0.0.1    1.change some funcs addr
 * 2022-02-16    zhengxiaoyu  v4.0.0.2    1.update format
 * 2022-03-24    zhengxiaoyu  v4.0.0.5    1.fix build bug
 *                                        2.add gain read when disable agc func
 * 2022-03-29    qiuchuitong  v4.0.0.6    1.fix mp mode bug
 * 2022-03-29    qiuchuitong  v4.0.0.7    1.update bt algo
 * 2022-03-29    qiuchuitong  v4.0.0.8    1.update algo call code
 *                                        2.add datatrans code
 * 2022-04-13    zhengxiaoyu  v4.0.0.9    1.update nadt process code
 * 2022-04-13    zhengxiaoyu  v4.0.1.0    1.add agcinfo reset
 *                                        2.add ecode current set
 * 2022-05-19    zhengxiaoyu  v4.0.1.1    1.delete some code
 *                                        2.update soft event
 * 2023-04-06    wenyongfeng  v4.1.0.1    1.fix bug
 *     
 * 2023-04-25    wenyongfeng  v4.1.0.2    1.add drv calculate bt 
 *
 * 2023-05-16    wenyongfeng  v4.2.0.0    1.open source 
 *
 * 2024-01-05    wenyongfeng  v4.2.0.1    1.fix compilation issue
 *
 * 2024-12-27    wenyongfeng  v4.3.0.0    1.update algo interface, fix bug
 * @endverbatim  */
...
#define   GH3X2X_DRV_MAJOR_VERSION_NUMBER        4      /**< major version number */
#define   GH3X2X_DRV_MINOR_VERSION_NUMBER        3      /**< minor version number */
#define   GH3X2X_DRV_REVISION_VERSION_NUMBER     0      /**< revision version number */
#define   GH3X2X_DRV_FIXED_VERSION_NUMBER        0      /**< fixed version number */
