...
#define  GH3X2X_UPROTOCOL_CMD_SET_ECG_CASCADE           (0x26)     /**< get Opened function */
...
/* macro of GH3X2X_UprotocolEcgCascadeCmd set */
#define  UPROTOCOL_CONN_ECG_CASCADE_LEN                 (1u)      /**< respond len */
#define  UPROTOCOL_CONN_ECG_CASCADE_INDEX               (0u)      /**< data index */
