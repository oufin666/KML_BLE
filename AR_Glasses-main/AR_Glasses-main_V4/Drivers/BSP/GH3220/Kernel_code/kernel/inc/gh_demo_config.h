...
#define __GH3X2X_INTERFACE__                            (__GH3X2X_INTERFACE_I2C__) //使用IIC通信
...
/*
 * GH3X2X_I2C_ID_SEL_1L0L    0 ///< MISO状态: LOW, CS状态: LOW, 7bit设备地址: 0x14, 8bit写地址: 0x28, 8bit读地址: 0x29
 * GH3X2X_I2C_ID_SEL_1L0H    1 ///< MISO状态: LOW, CS状态: HIGH, 7bit设备地址: 0x15, 8bit写地址: 0x2A, 8bit读地址: 0x2B
 * GH3X2X_I2C_ID_SEL_1H0L    2 ///< MISO状态: HIGH, CS状态: LOW, 7bit设备地址: 0x16, 8bit写地址: 0x2C, 8bit读地址: 0x2D
 * GH3X2X_I2C_ID_SEL_1H0H    3 ///< MISO状态: HIGH, CS状态: HIGH, 7bit设备地址: 0x17, 8bit写地址: 0x2E, 8bit读地址: 0x2F
 * */
...
#define __HARD_ADT_ALGO_CHECK_EN__                      (1)   //0: do not use algo to replace hard adt module in chip  1: use algo to replace hard adt mudule in chip
...
#define __SUPPORT_PPG_DOWNSAMP__                        (0)    /**< PPG downsample algorithm tye */
#define GH3X2X_PPG_DOWNSAMP_CHNL_NUM                    (0)    /**< PPG downsample chn number */
#endif
#endif
...
/* marco of wake up confirm enable*/
#define   GH3X2X_WAKE_UP_CONFIRM_EN                     (1)
...
#define   GH3X2X_IODATA_LOG(...)            do{\
                                            if(g_pSnprintfUserIn)\
                                            {\
                                                char gh3x2x_GH3X2X_INFO_LOG[GH3X2X_IODATA_LOG_MAX_LEN] = {0};\
                                                g_pSnprintfUserIn(gh3x2x_GH3X2X_INFO_LOG, GH3X2X_IODATA_LOG_MAX_LEN,__VA_ARGS__);\
                                                GH3X2X_PlatformLog((GCHAR *)gh3x2x_GH3X2X_INFO_LOG);\
                                            }\
